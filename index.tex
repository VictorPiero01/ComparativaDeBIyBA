...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=12cm]{./img/componentes.jpg} 
...
%%****
	...
	\begin{figure}[htb]
		\begin{center}
			\includegraphics[width=12cm]{./img/tomadedecisiones.jpg} 
			\caption{Ciclo de Inteligencia de Negocios}
		\end{center}
	\end{figure}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[height=10cm]{./img/framework.jpg} 
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=7cm]{./img/balance.png} 
